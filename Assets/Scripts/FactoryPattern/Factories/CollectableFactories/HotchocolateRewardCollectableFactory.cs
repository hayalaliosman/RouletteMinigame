...
public class HotchocolateRewardCollectableFactory : CollectableFactory
{
    public override async Task<ICollectable> CreateCollectableAsync()
    {
        ...
        {
            ICollectable collectable = operation.Result.GetComponent<HotchocolateRewardCollectable>();
            if (collectable != null)
            {
